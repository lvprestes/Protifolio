...
class ChooseModePage extends StatelessWidget {
  ...
  _showSnackbar(BuildContext context, String message) {
    var snackbar = SnackBar(
      ...
      backgroundColor: message.contains('Dark') ? AppColors.darkBackground : AppColors.lightBackground,
    );
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            ...
                            _showSnackbar(context, 'Dark theme selected');
                          },
                          child: ClipOval(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            ...
                            _showSnackbar(context, 'Light theme selected');
                          },
                          child: ClipOval(
                            child: BackdropFilter(
                              filter: ImageFilter.blur(sigmaX: 10, sigmaY: 10),
